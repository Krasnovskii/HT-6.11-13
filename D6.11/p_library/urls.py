...
from .views import AuthorEdit, AuthorList, author_create_many, books_authors_create_many, FriendAdd, FriendList, Book_list, redactions
...
urlpatterns =([
    ...
    url('redactions', redactions, name='redactions'),
